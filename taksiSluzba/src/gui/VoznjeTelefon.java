...
public class VoznjeTelefon extends JFrame {
    ...
    private void initMenu() {
        ...
        Object[][] sadrzaj = new Object[Preduzece.voznjaTelefon().size()][zaglavlje.length];

        for (int i = 0; i < Preduzece.voznjaTelefon().size(); i++) {
            Voznja porudzbina = Preduzece.voznjaTelefon().get(i);
